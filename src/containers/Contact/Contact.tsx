...
import {
  ...
  axiosEmail,
  body,
  contactFormHtmlEmail,
  contactFormTextEmail,
} from "../../helpers";
        ...
        <div className={classes.AddressSection}>
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              50/C-1 Valencia Town, Lahore - Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              6-D, Industrial Estate, Phase 1, Multan - Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              Plot # 43, Phase-1A, M3, Industrial City, Faisalabad - Pakistan.
            </div>
          </div>
          <div className={classes.AddressBlock}>
            <div className={classes.Heading}>Vehari Warehouse:</div>
            <div className={classes.Line}>
              8-KM, Multan Road, Vehari - Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              Room No. 201, First Floor, Good Earth Court, Block 13-A, Gulshan e
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              Kissan Textitle Industries, Near Grain Market, Rahim Yar Khan -
              Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              Star Rice Mill, Pakpattan Road, 99/9-L, Bholey Wali Chowk, Sahiwal
              - Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              Anwar Khan Market Near Bismillah Steel & Cement Dealer, Surkh
              Dehri Ring Road, Mardan - Pakistan.
            </div>
          ...
          <div className={classes.AddressBlock}>
            ...
            <div className={classes.Line}>
              A-23, Near MCB Bank, Site Area, Fateh Chowk, Hyderabad - Pakistan.
            </div>
