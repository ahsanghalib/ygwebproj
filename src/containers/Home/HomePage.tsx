...
const BusinessList = React.lazy(() => import('../../components/Business/BusinessList'))
                ...
                <div className={classes.Overlay}>
                    <div className={classes.Container}>
                        <h2 className={classes.Title}>
                            Success of Yaqoob Group is build on
                            number of Core Values</h2>
                        <Values/>
                    </div>
                </div>
            </div>
                    ...
                    <div className={classes.Container}>
                        <div className={classes.Content}>
                            <div className={classes.Title}>
                                It's all about creating a working environment that encourages people to
                                add their skills, and where they're provided with everything they
