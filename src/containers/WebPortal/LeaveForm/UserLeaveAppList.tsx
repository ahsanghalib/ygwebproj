...
function UserLeaveAppList() {
        ...
        {store.currentUserLeaveApplications.length === 0 ? (
          ...
          <div>
            <div className={classes.Header}>
              Already Sent Leave Applications and Status
            </div>
            <Table
              size="small"
  ...
  return (
    <Paper className={classes.LeaveAppList}>{userApplicatoinsList()}</Paper>
  );
}

export default UserLeaveAppList;
