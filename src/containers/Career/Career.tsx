    ...
    try {
      ...
      dispatch(
        appStatusAction(
          false,
          false,
          "Thanks for your feedback. Our team will contact you shortly."
        )
      );
    } catch (err) {
      dispatch(
                ...
                return (
                  <form onSubmit={bag.onSubmit} onReset={bag.onReset}>
                    <TextField
                      ...
                      helperText={
                        bag.errors.fullName !== "" ? bag.errors.fullName : " "
                      }
                    ...
                    <FormControl style={{ minWidth: "120px" }}>
                      ...
                      <FormHelperText>
                        {bag.errors.gender !== "" ? bag.errors.gender : " "}
                      </FormHelperText>
                    </FormControl>
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.address !== "" ? bag.errors.address : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.city !== "" ? bag.errors.city : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.country !== "" ? bag.errors.country : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.phone !== "" ? bag.errors.phone : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.email !== "" ? bag.errors.email : " "
                      }
                      error={bag.errors.email !== ""}
                    />

                    <FormControl style={{ minWidth: "120px" }}>
                      <InputLabel id="edu-level-label">
                      ...
                      <Select
                        ...
                        onChange={bag.onChange}
                      >
                        <MenuItem value={"Diploma (Post Matric)"}>
                          Diploma (Post Matric)
                        </MenuItem>
                        <MenuItem value={"Intermediate"}>Intermediate</MenuItem>
                        <MenuItem value={"Graduation"}>Graduation</MenuItem>
                        <MenuItem value={"Diploma (Post Graduation)"}>
                          Diploma (Post Graduation)
                        </MenuItem>
                        <MenuItem value={"Masters"}>Masters</MenuItem>
                        <MenuItem value={"MSc (Hons) Agri"}>
                          MSc (Hons) Agri
                        </MenuItem>
                        <MenuItem value={"BSc (Hons) Agri"}>
                          BSc (Hons) Agri
                        </MenuItem>
                      ...
                      <FormHelperText>
                        {bag.errors.highestQualification !== ""
                          ? bag.errors.highestQualification
                          : " "}
                      </FormHelperText>
                    </FormControl>
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.education ? bag.errors.education : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.institution ? bag.errors.institution : " "
                      }
                    ...
                    <TextField
                      ...
                      helperText={
                        bag.errors.workHistory
                          ? bag.errors.workHistory
                          : `(Starting with your present post, list IN REVERSE ORDER 
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.experience ? bag.errors.experience : " "
                      }
                    ...
                    <TextField
                      ...
                      className={classes.TextFields}
                      helperText={
                        bag.errors.disability ? bag.errors.disability : " "
                      }
                    ...
                    <TextField
                      ...
                      helperText={
                        bag.errors.strengths
                          ? bag.errors.strengths
                          : `(Please  be short and  precise)`
                      }
                    />
